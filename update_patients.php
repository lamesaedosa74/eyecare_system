                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="patient-info-header">
                            <div class="mrn-display">
                                <i class="fas fa-id-card me-2"></i>MRN: <?php echo htmlspecialchars($patient['mrn']); ?>
                            </div>
                            <div>
                                <span class="badge bg-info text-dark">
                                    <i class="fas fa-calendar-alt me-1"></i>
                                    Created: <?php echo date('M j, Y', strtotime($patient['created_at'])); ?>
                                </span>
                                <?php if ($patient['updated_at']): ?>
                                    <span class="badge bg-warning text-dark ms-2">
                                        <i class="fas fa-sync-alt me-1"></i>
                                        Updated: <?php echo date('M j, Y', strtotime($patient['updated_at'])); ?>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <form method="POST" id="editPatientForm">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="medical_history" name="medical_history" rows="4"><?php 
                                    echo htmlspecialchars($patient['medical_history']);
                                ?></textarea>
                            </div>

                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="patient_view.php?id=<?php echo $patient_id; ?>" class="btn btn-secondary me-md-2">
                                    <i class="fas fa-arrow-left me-2"></i>Back to Patient View
                                </a>
